...
def add_sparse_inst_config(cfg):
    ...
    # cfg.MODEL.BACKBONE.NAME = "build_intern_image_backbone"
    # cfg.MODEL.BACKBONE.TYPE = "intern_image"
    cfg.MODEL.BACKBONE.NAME = "build_inceptionnext_backbone"
    cfg.MODEL.BACKBONE.TYPE = "inceptionnext"
    cfg.MODEL.BACKBONE.DROP_PATH_RATE = 0.5
    cfg.MODEL.BACKBONE.OUT_FEATURES = ["Inx1", "Inx2", "Inx3", "Inx4"]
    ...
    cfg.MODEL.SPARSE_INST.ENCODER.NAME = "PAFPNASPPEncoder"
    cfg.MODEL.SPARSE_INST.ENCODER.NORM = ""
    cfg.MODEL.SPARSE_INST.ENCODER.IN_FEATURES = ["res3", "res4", "res5"]
    # cfg.MODEL.SPARSE_INST.ENCODER.IN_FEATURES = ["In2", "In3", "In4"]
    # cfg.MODEL.SPARSE_INST.ENCODER.IN_FEATURES = ["Inx2", "Inx3", "Inx4"]
    ...
    # cfg.MODEL.SPARSE_INST.DECODER.NAME = "GroupIAMDecoder"
    cfg.MODEL.SPARSE_INST.DECODER.NUM_MASKS = 100
    cfg.MODEL.SPARSE_INST.DECODER.NUM_CLASSES = 80
    # cfg.MODEL.SPARSE_INST.DECODER.NUM_CLASSES = 20
    ...
    cfg.MODEL.SPARSE_INST.DECODER.OUTPUT_IAM = True
