...
# from model.backbones.intern_image import build_intern_image_backbone
...
class SparseInst(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # encoder & decoder
        self.encoder = build_sparse_inst_encoder(cfg, self.output_shape)
    ...
    def forward(self, batched_inputs):
        # print("backbone.output_shape:", self.output_shape)
